...
class OrdersWriterTest {
    ...
    @Test
    void NoOrder() {
        assertEquals("{\"orders\": []}", OrdersWriter.getContents(new Orders()));
    }

    @Test
    void OneOrder() {
        String order0 = "{\"id\": 0, \"products\": []}";
        assertEquals("{\"orders\": [" + order0 + "]}", OrdersWriter.getContents(orders));
    }
    ...
    void TwoOrders() {
        ...
        assertEquals("{\"orders\": [" + order0Json + ", " + order1Json + "]}", OrdersWriter.getContents(orders));
    }
    ...
    void OneOrderWithOneProduct() {
        ...
        assertEquals("{\"orders\": [" + order0Json + "]}", OrdersWriter.getContents(orders));
    }
